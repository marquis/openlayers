...
OpenLayers.Layer.Djatoka = OpenLayers.Class(OpenLayers.Layer.Grid, {
	...
	viewerWidth: 512, 
	viewerHeight: 512, 
	minDjatokaLevelDimension: this.standardTileSize,
    ...
    initializeDjatoka: function(options) {
        ...
        // viewerLevel is the smallest useful zoom level: i.e., it is the largest level one tile on a side.
        var viewerLevel = Math.ceil(Math.min(minLevel, Math.min(
    ...
    getURL: function (bounds) {  
        ...
        var x = (bounds.left - this.tileOrigin.lon);
        var y = (this.tileOrigin.lat - bounds.top);
